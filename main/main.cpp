...
#define PHASE_UH_GPIO 8
#define PHASE_UL_GPIO 16
#define PHASE_VH_GPIO 18
#define PHASE_VL_GPIO 7
#define PHASE_WH_GPIO 17
#define PHASE_WL_GPIO 15

#define MOTOR_PP     8
#define MT6701_SPI_HOST SPI2_HOST
#define MT6701_SPI_SCLK_GPIO 13
#define MT6701_SPI_MISO_GPIO 14
...
BLDCDriver6PWM driver = BLDCDriver6PWM(PHASE_UH_GPIO, PHASE_UL_GPIO, PHASE_VH_GPIO, PHASE_VL_GPIO, PHASE_WH_GPIO, PHASE_WL_GPIO);
...
extern "C" void app_main(void)
{
    ...
    foc_knob_config_t cfg = {
        ...
        .param_list_num = MOTOR_ON_OFF_STRONG_DETENTS,
